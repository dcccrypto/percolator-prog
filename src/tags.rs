...
/// PERC-303: Deposit into junior tranche of LP vault.
pub const TAG_LP_VAULT_DEPOSIT_JUNIOR: u8 = 41;
/// PERC-303: Deposit into senior tranche of LP vault.
pub const TAG_LP_VAULT_DEPOSIT_SENIOR: u8 = 42;
